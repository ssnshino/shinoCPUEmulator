...
for(const m of ['/*__CSS__*/','/*__MEMORY__*/','/*__BUS__*/','/*__KEYBOARD__*/','/*__FLAGS__*/','/*__DECODER__*/','/*__CPU__*/','/*__CGROM__*/','/*__SYSTEM_ROM__*/','/*__VIDEO__*/','/*__APP__*/'])if(h.includes(m))throw Error('unresolved '+m);
...
if(scripts.length!==10)throw Error('inline script count '+scripts.length);

...
for(const m of ['/*__CSS__*/','/*__MEMORY__*/','/*__BUS__*/','/*__KEYBOARD__*/','/*__BEEPER__*/','/*__BLOCK_DEVICE__*/','/*__CBIOS__*/','/*__CPM22__*/','/*__SYSTEM_DISK__*/','/*__FLAGS__*/','/*__DECODER__*/','/*__CPU__*/','/*__CGROM__*/','/*__SYSTEM_ROM__*/','/*__VIDEO__*/','/*__APP__*/'])if(h.includes(m))throw Error('unresolved '+m);
for(const id of ['powerBtn','crtCanvas','crtViewport','displayDevice','keyboardCapture','statusPc','statusR','statusT','statusLast','statusVideo','runPauseBtn','stepBtn','moreMenu','referenceLink'])if(!h.includes(`id="${id}"`))throw Error('missing DOM id '+id);
...
if(!h.includes('VIRTUAL DISK A')||!h.includes('CP/M 2.2 · S80B v2 · 77×26×128'))throw Error('Virtual Disk A CP/M identity missing');
...
if(scripts.length!==15)throw Error('inline script count '+scripts.length);

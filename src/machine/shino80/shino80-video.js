(function(root,factory){
  ...
  class Shino80TextVideo{
    constructor(bus,canvas,{vramBase=TEXT_VRAM_BASE,cgRom=cgApi.CG_ROM_IMAGE}={}){
      ...
      this.bus=bus;this.canvas=canvas;this.vramBase=vramBase&0xFFFF;this.cgRom=cgRom;
  ...
  return {Shino80TextVideo,TEXT_VRAM_BASE,COLS,ROWS,CELL_COUNT,SCREEN_W,SCREEN_H};
});
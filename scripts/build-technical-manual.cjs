...
function buildData(){
 ...
 const files=['src/cpu/z80/z80-core.js','src/cpu/z80/z80-decoder.js','src/cpu/z80/z80-flags.js','src/machine/shino80/shino80-bus.js','src/machine/shino80/shino80-memory.js','src/machine/shino80/shino80-video.js','src/firmware/shino80/shino80-system-rom.js','src/firmware/shino80/shino80-cgrom.js','src/firmware/shino80/shino80-cbios.js','src/devices/shino80/shino80-keyboard.js','src/devices/shino80/shino80-block-device.js'];
 return {version:'0.1',baseline:'BIOS/MON v0.3 + pageable firmware v0.4 + RAM handoff v0.5 + block device/CBIOS v0.1 candidates',revision:'feature/shino80-cbios-v01-20260926',families,instructions,

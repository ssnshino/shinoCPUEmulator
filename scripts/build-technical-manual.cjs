...
function buildData(){
 ...
 return {version:'0.1',baseline:'BIOS/MON v0.3 + pageable firmware v0.4 candidate',revision:'feature/shino80-pageable-firmware-v04-20260926',families,instructions,
